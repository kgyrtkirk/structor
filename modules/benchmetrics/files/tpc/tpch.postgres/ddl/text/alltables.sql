...
COPY part FROM '/tmp/tpch-generate/part.tbl' DELIMITER '|' CSV;
COPY region FROM '/tmp/tpch-generate/region.tbl' DELIMITER '|' CSV;
COPY nation FROM '/tmp/tpch-generate/nation.tbl' DELIMITER '|' CSV;
COPY supplier FROM '/tmp/tpch-generate/supplier.tbl' DELIMITER '|' CSV;
COPY partsupp FROM '/tmp/tpch-generate/partsupp.tbl' DELIMITER '|' CSV;
COPY customer FROM '/tmp/tpch-generate/customer.tbl' DELIMITER '|' CSV;
COPY orders FROM '/tmp/tpch-generate/orders.tbl' DELIMITER '|' CSV;
COPY lineitem FROM '/tmp/tpch-generate/lineitem.tbl' DELIMITER '|' CSV;
