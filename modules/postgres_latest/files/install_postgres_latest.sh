...
sudo cp /vagrant/modules/postgres_server/files/postgresql.conf /var/lib/pgsql/9.6/data
sudo chown postgres:postgres /var/lib/pgsql/9.6/data/postgresql.conf
sudo chmod 600 /var/lib/pgsql/9.6/data/postgresql.conf
sudo cp /vagrant/modules/postgres_server/files/pg_hba.conf /var/lib/pgsql/9.6/data
